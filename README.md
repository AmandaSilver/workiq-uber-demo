...
| `POST /api/find-hotels` | 🟣 WebIQ | hotels ranked by distance (default 5-star; accepts `stars` 1–5) |
...
hotels in `hotels.json` are real, publicly-listed San Francisco hotels across 3-, 4- and 5-star tiers
(the chat can re-search any tier, e.g. "find a 3-star hotel").
